...
stripe.api_key = 'sk_test_51KeQAQAFuYGEEBRbsmBkonOTNorK8J0aCAPvbMULz1wl9QzWWQ64q4JPolvlZYrr63CDQvsYQQNEUUPFctCtlQ2L00e0rWUoxO'
...
def home():
    ...
    return render_template("index.html", current_user=current_user, products_in_cart=products_in_cart)
...
def checkout():
    ...
    if request.method == 'POST':
        ...
        if not out_of_stock:
            ...
            order_details = OrderNumbers(order_number=order_number, first_name=first_name, last_name=last_name,
                                         email=email,
        ...
        return render_template("checkout.html", current_user=current_user, price=price,
                               products_in_cart=products_in_cart)
    return render_template("checkout.html", current_user=current_user, price=price, products_in_cart=products_in_cart)
